...
class PhysicalAgent < SpaceForceAgent
  ...
  def initialize(agent, config, fallback)
    ...
    # We use simulator.getProperties() to access the global Term
    ...
    # This is the key value your Python script is changing!
  ...
  def apply_body_slowdown
    ...
    GhostAgentManager.get_bodies.each do |body|
      ...
      resistance = 0.5 * Math.exp(2.0 * (1.2 - dist))
    ...
    if total_resistance > 0
      ...
      adjusted_speed = base_speed / (1.0 + total_resistance)
